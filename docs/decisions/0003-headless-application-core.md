...
Haplux has an interactive terminal interface, but coordinate conversion, provenance,
...
The TUI is a client of that layer. A headless `haplux analyze` command is another client
...
- CI and future workflow engines can run Haplux without a terminal.
